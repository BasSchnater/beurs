...
#    stock['SMA365'].plot(label='MA365', color='orange',linestyle='dotted')
    stock['SMA200'].plot(label='MA200', color='red', linestyle='dotted')
    stock['SMA100'].plot(label='MA100', color='red', linewidth=2)
    stock['SMA50'].plot(label='MA50', color='blue', linewidth=2)
